...
if (isset($_POST["field6"])) {
	$error = lost_password($_POST["field1"], $_POST["field2"], $_POST["field3"], $_POST["field4"], $_POST["field5"],
	...
	if (strpos($error, ":") !== false) {
		$_POST["field4"] = str_right($error, ":");
		$error = str_left($error, ":");
	}
}
?>
...
<body bgcolor="#000000">
<form method="post" action="lost-pwd.php">
...
<tr>
<td class="comic-text" align="left" nowrap="nowrap">New Password:</td>
<td class="comic-text" align="right"></td>
</tr>
<tr>
...
<td class="comic-text" align="right"><input name="field6" type="submit" value="Set Password"/></td>
</tr>
